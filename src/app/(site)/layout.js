...
export default function SiteLayout({ children }) {
  return (
    <>
      <header className="sticky top-0 z-30 border-b border-cyan-200/20 bg-slate-950/65 backdrop-blur-xl">
        <nav className="mx-auto flex w-full max-w-6xl items-center gap-4 px-6 py-4">
          ...
          <Link href="/login" className="ml-auto rounded-md bg-cyan-500/20 px-3 py-1.5 text-sm font-medium text-cyan-200 hover:bg-cyan-500/30">
            Login
          </Link>
        </nav>
      </header>
